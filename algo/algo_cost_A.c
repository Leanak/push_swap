...
/*   Updated: 2025/07/06 12:44:36 by lenakach         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	calcul_total_cost_a(int i_b, t_stack *s_b, t_stack *s_a, t_detail **det)
{
	int	cost_1;
	int	cost_2;
	int	cost_3;
	...
	i_a = (*det)->index_a;
	cost_1 = calcul_cost_both_up(i_a, i_b);
	cost_2 = calcul_cost_both_down(i_a, i_b, s_a, s_b);
	cost_3 = calcul_cost_diff(s_a, s_b, i_a, i_b);
